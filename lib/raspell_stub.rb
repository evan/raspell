...
class Aspell
  ...
  # Creates an Aspell instance. All parameters are optional and have default values. In most cases it is enough to create an Aspell-instance with only a dictionary (for example: <tt>Aspell.new("us")</tt>).
  ...
  CheckerOptions = A list of checker options
  DictionaryOptions = A list of dictionary options
  FilterOptions = A list of filter options
  MiscOptions = A list of misc options
  RunTogetherOptions = A list of run together options
  UtilityOptions = A list of utility options
